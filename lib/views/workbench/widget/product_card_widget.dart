...
class ProductCardWidget extends StatefulWidget {
  const ProductCardWidget(
      {Key? key, required this.order, this.onTap, this.isShowRelated = false})
      : super(key: key);
  final OrderModel order;
  final void Function(dynamic item, int index)? onTap;
  final bool isShowRelated;
  @override
...
class _ProductCardWidgetState extends State<ProductCardWidget> {
  ...
  Widget _buildProductCard(item, index) {
    final hasImage =
        item.imgs != null && item.imgs.isNotEmpty && item.imgs[0] != null;
    return Container(
                    ...
                    GestureDetector(
                      onTap: () {
                        if (item.productUrl.isNotEmpty) {
                          launchUrl(Uri.parse('https://${item.productUrl}'),
  ...
  Widget _buildRelatedProducts(item, index) {
    ...
    final hasImage = related.images != null &&
        related.images.isNotEmpty &&
        related.images[0] != null;
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              Routers.push(Routers.productDetail,
                                  {'id': related.goods['id']});
                            },
                            child: LoadAssetImage(
                              image: 'workbench/relevancy',
